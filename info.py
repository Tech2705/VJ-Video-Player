...
ADMIN = int(environ.get('ADMIN', '1876329759'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002892668990'))
...
LINK_URL = environ.get("LINK_URL", "https://a2zsafelink.blogspot.com/p/a.html")
